...
<head>
  ...
  <title>El chismoso | <?php echo $__env->yieldContent('titulo'); ?></title>
  ...
  ?>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/profile/<?php echo e($foto); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav_-item">
            <a href="<?php echo e(route("admin.tablero")); ?>" class="nav-link">
...
<?php /**PATH C:\Users\Manuel Ernesto\Desktop\Graficos Avanzados\ControladorMasBonito\resources\views/layouts/admin.blade.php ENDPATH**/ ?>